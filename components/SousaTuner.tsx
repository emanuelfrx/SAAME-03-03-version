...
const LiveTestWord: React.FC<LiveTestWordProps> = ({ word, fontFamily, font, settings }) => {
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-1">
                            <label className="text-xs text-gray-400">Left Sidebearing</label>
                            <input 
                                type="number"
                                value={currentLsb}
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-1">
                            <label className="text-xs text-gray-400">Right Sidebearing</label>
                            <input 
                                type="number"
                                value={currentRsb}
